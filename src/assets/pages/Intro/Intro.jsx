...
function IntroHome() {
    ...
    return (
        <>
            <BannerImage image={'/images/church-1.jpg'} title={"教會簡介"} />
            <div className="container mx-auto py-20">
                <h1 className="text-5xl text-center font-bold text-primary-500">七賢路禮拜堂簡介</h1>
                <div className="grid grid-cols-2 gap-4 my-15">
                    <div>
                        <img src="https://images.unsplash.com/photo-1502987846294-e7ec70f4b393?q=80&w=1973&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" className="rounded-2xl" alt="" />
                    </div>
                    <div className="p-4">
                        <h2 className="text-4xl font-bold mb-4 text-primary-500">教會的宗旨</h2>
                        <span className="text-2xl text-primary-500">本教會以事奉獨一真神<br />遵行聖經真理<br />增進聖徒信德<br />廣傳基督福音<br />引領世人歸主為宗旨。</span>
                    </div>
                    <div className="p-4 mt-8">
                        <h2 className="text-4xl font-bold mb-4 text-primary-500">教會的信仰</h2>
                        <div className={`relative transition-all duration-500 ease-in-out overflow-hidden ${isExtend ? 'max-h-full' : 'max-h-[400px]'
                            }`}>
                            <ul className="text-2xl list-disc pl-6 text-primary-500">
                    ...
                    <div className="mt-8">
                        <img src="images/church-1.jpg" className="rounded-2xl" alt="" />
                    </div>
                    <div className="p-4 mt-8">
                        <h2 className="text-4xl font-bold mb-4 text-primary-500">教會的治理</h2>
                        <span className="text-2xl text-primary-500">教會本於「長老治會」與「地方教會」的原則進行治理，與跨地方的「宗派性教會」以及「聘請牧師治會」的牧師制度有很大的不同。<br /><br />我們認定的地方教會是一個教會，由該地方性會堂的信徒中栽培出領袖，並按立為長老，來治理監督牧養教會。<br /><br />根據聖經的記載長老係多數，是全群的監督（徒２０：２８上），牧養教會的人（徒２０：２８下；彼前５：２上），照管教會的人（提前３：５、５：１７；多１：７；彼前５：２下）。<br /><br />「地方教會」與「長老治會」是聖經中的教導，也是聖經中的榜樣。故我們遵行地方教會路線，並行長老治會</span>
                    </div>
                </div>
            </div>
        </>
